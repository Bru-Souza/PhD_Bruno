...
if model_type == "Object detection":
    ...
    with st.form("task"):
        ...
        # Set iou_thres
        st.session_state.model_iou = float(st.slider("Select IoU threshold",0.0, 1.00, 0.60))

        # set conf_thres
        st.session_state.model_conf = float(st.slider("Confidence Threshold", 0.0, 1.0, 0.60, 0.01))
